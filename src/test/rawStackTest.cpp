...
BOOST_AUTO_TEST_CASE( rawMethodTest )
{
	...
	BOOST_CHECK_THROW( tRawStack02.swap( 100, 0 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack02.swap( -100, 0 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack02.swap( 0, 100 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack02.swap( 0, -100 ), std::out_of_range );
	...
	BOOST_CHECK_THROW( tRawStack03.copy( 100 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack03.copy( 0 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack03.copy( -100 ), std::out_of_range );
	...
	BOOST_CHECK_THROW( tRawStack04.copy( 100 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack04.copy( 0 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack04.copy( -100 ), std::out_of_range );
	...
	BOOST_CHECK_THROW( tRawStack05.insert( 0 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack05.insert( 100 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack05.insert( -100 ), std::out_of_range );
	...
	BOOST_CHECK_THROW( tRawStack06.remove( 0 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack06.remove( 100 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack06.remove( -100 ), std::out_of_range );
	...
	BOOST_CHECK_THROW( tRawStack07.erase( 0 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack07.erase( 100 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack07.erase( -100 ), std::out_of_range );
	...
	BOOST_CHECK_THROW( tRawStack08.iterate( 0 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack08.iterate( 100 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack08.iterate( -100 ), std::out_of_range );
	...
	BOOST_CHECK_THROW( tRawStack09.pop( 100 ), std::runtime_error );
	BOOST_CHECK_THROW( tRawStack09.pop( -100 ), std::runtime_error );
...
BOOST_AUTO_TEST_CASE( getTest )
{
	...
	BOOST_CHECK_THROW( tRawStack04.getRelativeIndex( 1000 ), std::out_of_range );	
	BOOST_CHECK_THROW( tRawStack04.getRelativeIndex( -1000 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack04.getRelativeIndex( 0 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack04.getAbsoluteIndex( 1000 ), std::out_of_range );	
	BOOST_CHECK_THROW( tRawStack04.getAbsoluteIndex( -1000 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack04.getAbsoluteIndex( 0 ), std::out_of_range );
	...
	BOOST_CHECK_THROW( tRawStack05.getType( 0 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack05.getType( 100 ), std::out_of_range );
	BOOST_CHECK_THROW( tRawStack05.getType( -100 ), std::out_of_range );
